...
#
# Change Log:
#	2012-05-21 Matt Johnson <mgj4@duke.edu>
#	  - Edited options for more control via GUI
...
from simuOpt import *
setOptions(optimized=True,quiet=True, alleleType='binary', version='1.0.1')
from simuPOP import *
...
options = [
	...
	'label':"HapMap Populations to form initial population"
	},
	{'name':'skip',
	'default':True,
	'type':bool,
	'label':"Skip Downloading and File Checking?"
	}
]
